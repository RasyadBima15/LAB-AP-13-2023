...
hilda = Warrior("hilda", 40)
lance = Assassin("lance", 65)
rafaela = Support("rafaela", 70)


print("health (before)", hilda.getHealth())
lance.Attack(hilda)

print("health (after)", hilda.getHealth())
print("-"*10)

print("hilda (health)", hilda.getHealth())
print("rafaela (speed)", rafaela.getSpeed())

rafaela.special(hilda)
